...
public class StreamFuncFragment extends Fragment {
    ...
    @BindView(com.moelive.live.demo.R.id.front_camera_mirror)
    protected CheckBox mFrontMirrorCB;
    @BindView(com.moelive.live.demo.R.id.paint_streaming)
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View view = inflater.inflate(com.moelive.live.demo.R.layout.stream_func_fragment, container, false);
    ...
    @OnCheckedChanged(com.moelive.live.demo.R.id.front_camera_mirror)
    protected void onFrontMirrorChecked(boolean isChecked) {
        mStreamer.setFrontCameraMirror(isChecked);
    }

    @OnCheckedChanged(com.moelive.live.demo.R.id.paint_streaming)
