...
public class BaseCameraActivity extends Activity implements
    ...
    @BindView(com.moelive.live.demo.R.id.gl_surface_view)
    protected GLSurfaceView mGLSurfaceView;
    @BindView(com.moelive.live.demo.R.id.chronometer)
    protected Chronometer mChronometer;
    @BindView(com.moelive.live.demo.R.id.flash)
    protected ImageView mFlashView;
    @BindView(com.moelive.live.demo.R.id.url)
    protected TextView mUrlTextView;
    @BindView(com.moelive.live.demo.R.id.start_stream_tv)
    protected TextView mStreamingText;
    @BindView(com.moelive.live.demo.R.id.debug_info)
    ...
    protected int getLayoutId() {
        return com.moelive.live.demo.R.layout.base_camera_activity;
    }
    ...
    @OnClick(com.moelive.live.demo.R.id.start_stream_tv)
    ...
    @OnClick(com.moelive.live.demo.R.id.switch_cam)
    protected void onSwitchCamera() {
        // 切换前后摄像头
        mStreamer.switchCamera();
    }

    @OnClick(com.moelive.live.demo.R.id.flash)
