...
public class AudioFuncFragment extends Fragment {
    ...
    @BindView(com.moelive.live.demo.R.id.audio_ld)
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View view = inflater.inflate(com.moelive.live.demo.R.layout.audio_func_fragment, container, false);
    ...
    @OnCheckedChanged(com.moelive.live.demo.R.id.bgm)
    ...
    @OnClick(com.moelive.live.demo.R.id.bgm_filter)
    ...
    @OnClick(com.moelive.live.demo.R.id.audio_filter)
