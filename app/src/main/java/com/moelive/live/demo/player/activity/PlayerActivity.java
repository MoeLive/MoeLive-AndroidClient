...
public class PlayerActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.moelive.live.demo.R.layout.activity_player);

        setActionBarLayout(com.moelive.live.demo.R.layout.media_actionbar, this);
        permissionCheck();
    ...
    public void setActionBarLayout(int layoutId, Context mContext) {
        ...
        if (null != actionBar) {
            ...
            mediaNet = (Button) findViewById(com.moelive.live.demo.R.id.media_network);
            mediaHistory = (Button) findViewById(com.moelive.live.demo.R.id.media_history);
            mediaSetting = (Button) findViewById(com.moelive.live.demo.R.id.media_setting);
    ...
    private void setDefaultFragment() {
        ...
        transaction.replace(com.moelive.live.demo.R.id.contentFrame, localFragment);
        transaction.commit();
    }
    ...
    public void onClick(View view) {
        Intent intent;
        switch (view.getId()) {
            case com.moelive.live.demo.R.id.media_network:
                ...
                break;
            case com.moelive.live.demo.R.id.media_history:
                Intent intent2 = new Intent(this, HistoryActivity.class);
                startActivity(intent2);
                Toast.makeText(PlayerActivity.this, "mediaHistory", Toast.LENGTH_SHORT).show();
                break;
            case com.moelive.live.demo.R.id.media_setting:
