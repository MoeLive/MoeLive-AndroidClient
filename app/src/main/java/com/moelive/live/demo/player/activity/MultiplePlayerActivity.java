...
public class MultiplePlayerActivity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(com.moelive.live.demo.R.layout.activity_multiple_player);

        mMasterSurfaceView = (SurfaceView) findViewById(com.moelive.live.demo.R.id.player_master);
        mSlaveSurfaceView = (SurfaceView) findViewById(com.moelive.live.demo.R.id.player_slave);
        mSlaveSurfaceView2 = (SurfaceView) findViewById(com.moelive.live.demo.R.id.player_slave2);
        mMaster = (TextView) findViewById(com.moelive.live.demo.R.id.control_master);
        mSlave = (TextView) findViewById(com.moelive.live.demo.R.id.control_slave);
