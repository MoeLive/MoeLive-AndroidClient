package com.moelive.live.demo.player.view;
...
import com.moelive.live.demo.player.activity.FloatingPlayingActivity;
import com.moelive.live.demo.player.model.KSYFloatingPlayer;
...
public class KSYFloatingWindowView extends RelativeLayout {
    ...
    private void init(Context context) {
        ...
        LayoutInflater.from(context).inflate(com.moelive.live.demo.R.layout.floating_window, this);

        mTextureView = (TextureView) findViewById(com.moelive.live.demo.R.id.floating_window_player_view);
        mQuit = (ImageView) findViewById(com.moelive.live.demo.R.id.floating_window_quit);
