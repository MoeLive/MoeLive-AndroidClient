package com.moelive.live.demo.player.util;
...
public class ProgressTextView extends View {
    ...
    public ProgressTextView(Context context, AttributeSet attrs) {
        ...
        if (null != context && attrs != null) {
            TypedArray array = context.obtainStyledAttributes(attrs, com.moelive.live.demo.R.styleable.ProgressTextView);
            mTextColor = array.getColor(com.moelive.live.demo.R.styleable.ProgressTextView_ptv_textColor, Color.WHITE);
            mTextSize = array.getDimensionPixelSize(com.moelive.live.demo.R.styleable.ProgressTextView_ptv_thumWidth, 36);
            float thumHeight = array.getDimension(com.moelive.live.demo.R.styleable.ProgressTextView_ptv_thumWidth, 20);
