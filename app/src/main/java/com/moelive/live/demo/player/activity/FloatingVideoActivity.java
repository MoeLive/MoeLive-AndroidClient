...
public class FloatingVideoActivity extends Activity implements Handler.Callback {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(com.moelive.live.demo.R.layout.activity_floating);

        mQosLayout = (RelativeLayout) findViewById(com.moelive.live.demo.R.id.player_qos);
        mPlayerPanel = (RelativeLayout) findViewById(com.moelive.live.demo.R.id.player_panel);
        mTextureView = (TextureView) findViewById(com.moelive.live.demo.R.id.player_view);
        mTextureView.setSurfaceTextureListener(mSurfaceTextureListener);
        mPlayerStartBtn = (ImageView) findViewById(com.moelive.live.demo.R.id.player_start);
        mFloatingPlaying = (ImageView) findViewById(com.moelive.live.demo.R.id.floating_playing);
